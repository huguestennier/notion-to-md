...
export const image = async (alt: string, href: string, dir?: string, notionDir?: string) => {
  const filePath = await downloadImage(href, dir, notionDir)
...
const downloadImage = async (href: string, dir?: string, notionDir?: string) => {
